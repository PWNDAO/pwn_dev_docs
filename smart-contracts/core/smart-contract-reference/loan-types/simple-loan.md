...
* `bytes calldata`**`extra`** - Auxiliary data that are emitted in the [`LOANCreated`](simple-loan.md#loancreated) event. They are not used in the contract logic.
...
<summary><code>extendLOAN</code></summary>
...
* `bytes`**`extra`** - Auxiliary data provided by the caller to the [`createLOAN`](simple-loan.md#createloan) function
...
<summary><code>NonExistingLoan</code></summary>
